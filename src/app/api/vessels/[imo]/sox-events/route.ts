...
import { buildDefaultSoxApiDeps } from "../sox-watch/_lib";
import type { SoxApiDeps } from "../sox-watch/_lib";

/**
 * GET /api/vessels/[imo]/sox-events
 *
 * Returns the recent SOx compliance events (append-only) for a vessel,
 * newest first. 404 when the vessel is unknown.
 */
