...
export const REPORT_GENERATION_FAILED = "REPORT_GENERATION_FAILED" as const;
export const PACKAGE_NOT_FOUND = "PACKAGE_NOT_FOUND" as const;
export const PACKAGE_GENERATION_FAILED = "PACKAGE_GENERATION_FAILED" as const;
...
export type ErrorCode =
  ...
  | typeof REPORT_NOT_FOUND
  | typeof REPORT_GENERATION_FAILED
  | typeof PACKAGE_NOT_FOUND
  | typeof PACKAGE_GENERATION_FAILED
  | typeof NOTIFICATION_NOT_FOUND
  | typeof PACKAGE_VALIDATION_FAILED
