 ...
 */
export function generateAnnualMrvReport(input: MrvPipelineInput): MrvPipelineOutput {
  ...
  const version = buildReportVersion(input, aggregation, input.monitoringPlanResolution);
