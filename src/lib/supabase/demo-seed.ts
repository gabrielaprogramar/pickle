...
const OCR_MIRROR_DOCS: ReadonlyArray<{
  ...
  { id: "ocr-doc-perfect-bdn", title: "BDN — Aurora (Singapore, 2026-07-18)", documentType: "bdn", status: "approved", level: "HIGH", ocrConfidence: 0.95, family: "BDN" },
  { id: "ocr-doc-rotated-bdn", title: "BDN — Aurora (rotated 90°)", documentType: "bdn", status: "under_review", level: "MEDIUM", ocrConfidence: 0.6, family: "BDN" },
  { id: "ocr-doc-blurred-certificate", title: "IAPP Certificate — Aurora (blurred)", documentType: "certificate", status: "under_review", level: "MEDIUM", ocrConfidence: 0.45, family: "CERTIFICATE" },
  { id: "ocr-doc-unreadable-noon-report", title: "Noon Report — Aurora (unreadable)", documentType: "report", status: "processing", level: "VERY_LOW", ocrConfidence: 0.2, family: "NOON_REPORT" },
  { id: "ocr-doc-mixed-language", title: "BDN — Aurora (mixed-language supplier block)", documentType: "bdn", status: "extracted", level: "MEDIUM", ocrConfidence: 0.8, family: "BDN" },
  { id: "ocr-doc-duplicate-scan", title: "BDN — Aurora (duplicate page scan)", documentType: "bdn", status: "under_review", level: "MEDIUM", ocrConfidence: 0.75, family: "BDN" },
  { id: "ocr-doc-damaged-scan", title: "EU ETS Report — Aurora (damaged scan)", documentType: "eu_mrv", status: "processing", level: "VERY_LOW", ocrConfidence: 0.3, family: "EU_ETS" },
  { id: "ocr-doc-cropped-statement", title: "Account Statement — Aurora Shipping (cropped)", documentType: "other", status: "extracted", level: "MEDIUM", ocrConfidence: 0.8, family: "STATEMENT" },
...
export function buildDemoSeedTables(): Record<string, readonly unknown[]> {
  ...
  const fuelDeliveries: Array<Record<string, unknown>> = [
    ...
    { id: "fuel-nep-1", vesselId: "vsl-neptune", documentId: "doc-bdn-neptune-algeciras", supplier: "Cepsa Marine", port: "Algeciras", date: -3 * DAY, fuelType: "vlsfo", quantityMt: 550, density: 920.8, sulphur: 0.49, bdn: "BDN-2026-0731", status: "pending", voyageId: "voy-nep-1" },
  ...
  const reviewTasks: Array<Record<string, unknown>> = [
    { id: "rt-ocr-rotated", documentId: "ocr-doc-rotated-bdn", assignedTo: ownerId, status: "in_progress", priority: "high", dueAt: ahead(1 * DAY), reasonCode: "OCR_REVIEW_REQUIRED" },
    { id: "rt-ocr-blurred", documentId: "ocr-doc-blurred-certificate", assignedTo: ownerId, status: "pending", priority: "high", dueAt: ahead(2 * DAY), reasonCode: "OCR_REVIEW_REQUIRED" },
    ...
    { id: "rt-ocr-duplicate", documentId: "ocr-doc-duplicate-scan", assignedTo: ownerId, status: "pending", priority: "normal", dueAt: ahead(2 * DAY), reasonCode: "OCR_REVIEW_REQUIRED" },
    ...
    { id: "rt-bdn-horizon", documentId: "doc-bdn-horizon-hamburg", assignedTo: ownerId, status: "in_progress", priority: "normal", dueAt: ahead(3 * DAY), reasonCode: "BDN_RECONCILIATION_PENDING" },
    ...
    { id: "rt-mrv-atlas", documentId: "doc-mrv-atlas-2025", assignedTo: ownerId, status: "completed", priority: "normal", completedAt: ago(2 * DAY), reviewNote: "Verified MRV 2025 figures; submitted to THETIS.", reasonCode: null },
  ...
  const notifications: Array<Record<string, unknown>> = [
    { id: "ntf-1", type: "sox_alert", severity: "CRITICAL", vesselId: "vsl-neptune", title: "SOx watch — evidence required", message: "Neptune entered the Med SOx ECA with insufficient compliant-fuel evidence on file.", payload: { imo: "9338490", zone: "MED_SOX_ECA" } },
    { id: "ntf-2", type: "certificate_expiring", severity: "HIGH", vesselId: "vsl-horizon", title: "IAPP certificate expired", message: "IAPP for Horizon (IAPP-2023-0917) expired 5 days ago. No renewal on file.", payload: { imo: "9587420" } },
    ...
    { id: "ntf-6", type: "review_task", severity: "HIGH", vesselId: null, title: "Review needed — Noon report (unreadable)", message: "OCR quality VERY_LOW: ocr-doc-unreadable-noon-report requires re-scan.", payload: { documentId: "ocr-doc-unreadable-noon-report" } },
    { id: "ntf-7", type: "review_task", severity: "HIGH", vesselId: null, title: "Review needed — EU ETS report (damaged)", message: "OCR quality VERY_LOW: ocr-doc-damaged-scan requires re-scan.", payload: { documentId: "ocr-doc-damaged-scan" } },
    { id: "ntf-8", type: "review_task", severity: "MEDIUM", vesselId: null, title: "Review needed — rotated BDN", message: "ocr-doc-rotated-bdn scanned rotated 90°; fields low-confidence.", payload: { documentId: "ocr-doc-rotated-bdn" } },
    { id: "ntf-9", type: "fueleu", severity: "HIGH", vesselId: "vsl-atlas", title: "FuelEU — ISCC certificate missing", message: "B30 biofuel energy for Atlas 2025 lacks an ISCC certificate for full credit.", payload: { year: 2025 } },
    { id: "ntf-10", type: "fueleu", severity: "INFO", vesselId: "vsl-aurelia", title: "FuelEU 2026 provisional surplus", message: "Aurelia is tracking a 2.4 gCO2e/MJ surplus against the 2026 target.", payload: { year: 2026 } },
    { id: "ntf-11", type: "ets", severity: "MEDIUM", vesselId: "vsl-neptune", title: "EU ETS — MRV 2025 incomplete", message: "Neptune MRV 2025 draft is missing 6 voyages of noon fuel data.", payload: { year: 2025 } },
    { id: "ntf-12", type: "ets", severity: "MEDIUM", vesselId: "vsl-odyssey", title: "EU ETS — surrender plan in review", message: "Allowance budget review open for Odyssey 2025.", payload: { year: 2025 } },
    { id: "ntf-13", type: "fuel_delivery", severity: "MEDIUM", vesselId: "vsl-neptune", title: "BDN awaiting vessel assignment", message: "BDN-2026-0731 (Algeciras) could not be reconciled to a voyage.", payload: { documentId: "doc-bdn-neptune-algeciras" } },
    { id: "ntf-14", type: "fuel_delivery", severity: "INFO", vesselId: "vsl-horizon", title: "BDN reconciled", message: "BDN-2026-0727 reconciled to Rotterdam→Hamburg.", payload: { documentId: "doc-bdn-horizon-rotterdam" } },
    { id: "ntf-15", type: "noon_report", severity: "INFO", vesselId: "vsl-odyssey", title: "Noon report received", message: "Odyssey filed its noon report; consumption 24.8 t.", payload: { reportDate: "2026-08-03" } },
    { id: "ntf-16", type: "noon_report", severity: "INFO", vesselId: "vsl-aurelia", title: "Noon report received", message: "Aurelia filed its noon report; consumption 18.6 t.", payload: {} },
    { id: "ntf-17", type: "zone_event", severity: "INFO", vesselId: "vsl-atlas", title: "Atlas entered Med SOx ECA", message: "Detected entry at 39.20°N 17.40°E; sulphur on board 0.48%.", payload: { zone: "MED_SOX_ECA" } },
    { id: "ntf-18", type: "zone_event", severity: "INFO", vesselId: "vsl-aurelia", title: "Aurelia entered Med SOx ECA", message: "Detected entry at 40.85°N 3.15°E; sulphur on board 0.49%.", payload: { zone: "MED_SOX_ECA" } },
    { id: "ntf-19", type: "system", severity: "INFO", vesselId: null, title: "Demo data refreshed", message: "Deterministic demo dataset loaded for Poseidon Shipping Ltd.", payload: {} },
    { id: "ntf-20", type: "system", severity: "MEDIUM", vesselId: null, title: "Email ingestion queue clear", message: "All 9 queued email attachments processed in the last 24h.", payload: {} },
  ].map((n, i) => ({
    id: n.id,
